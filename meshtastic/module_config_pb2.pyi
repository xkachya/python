...
class ModuleConfig(google.protobuf.message.Message):
    ...
    @typing.final
    class DzhagaConfig(google.protobuf.message.Message):
        """
        ...
        class _Dzhaga_ModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ModuleConfig.DzhagaConfig._Dzhaga_Mode.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
            NONE: ModuleConfig.DzhagaConfig._Dzhaga_Mode.ValueType  # 0
            REMOTE: ModuleConfig.DzhagaConfig._Dzhaga_Mode.ValueType  # 1
            TARGET: ModuleConfig.DzhagaConfig._Dzhaga_Mode.ValueType  # 2

        class Dzhaga_Mode(_Dzhaga_Mode, metaclass=_Dzhaga_ModeEnumTypeWrapper):
            """
            TODO: REPLACE
            """

        NONE: ModuleConfig.DzhagaConfig.Dzhaga_Mode.ValueType  # 0
        REMOTE: ModuleConfig.DzhagaConfig.Dzhaga_Mode.ValueType  # 1
        TARGET: ModuleConfig.DzhagaConfig.Dzhaga_Mode.ValueType  # 2

        ENABLED_FIELD_NUMBER: builtins.int
        MODE_FIELD_NUMBER: builtins.int
        REMOTE_NODE_FIELD_NUMBER: builtins.int
        READY_BTN_PIN_FIELD_NUMBER: builtins.int
        FRBTN_PIN_1_FIELD_NUMBER: builtins.int
        FRBTN_PIN_2_FIELD_NUMBER: builtins.int
        FRBTN_PIN_3_FIELD_NUMBER: builtins.int
        FRBTN_TRIGGERED_HIGH_FIELD_NUMBER: builtins.int
        FRBTN_USE_PULLUP_FIELD_NUMBER: builtins.int
        enabled: builtins.bool
        """
        Whether the Module is enabled
        """
        mode: global___ModuleConfig.DzhagaConfig.Dzhaga_Mode.ValueType
        """
        Mode for Dzhaga Dzhaga Module operation
        """
        remote_node: builtins.str
        """
        Destination node name
        Example: 
        Maximum length of 15 characters
        """
        ready_btn_pin: builtins.int
        """
        GPIO pin to monitor for state changes
        """
        frbtn_pin_1: builtins.int
        """
        GPIO pin to monitor for state changes
        """
        frbtn_pin_2: builtins.int
        """
        GPIO pin to monitor for state changes
        """
        frbtn_pin_3: builtins.int
        """
        GPIO pin to monitor for state changes
        """
        frbtn_triggered_high: builtins.bool
        """
        Whether or not the GPIO pin state detection is triggered on HIGH (1)
        Otherwise LOW (0)
        """
        frbtn_use_pullup: builtins.bool
        """
        Whether or not use INPUT_PULLUP mode for GPIO pin
        Only applicable if the board uses pull-up resistors on the pin
        """
        ...
        def ClearField(self, field_name: typing.Literal["enabled", b"enabled", "frbtn_pin_1", b"frbtn_pin_1", "frbtn_pin_2", b"frbtn_pin_2", "frbtn_pin_3", b"frbtn_pin_3", "frbtn_triggered_high", b"frbtn_triggered_high", "frbtn_use_pullup", b"frbtn_use_pullup", "mode", b"mode", "ready_btn_pin", b"ready_btn_pin", "remote_node", b"remote_node"]) -> None: ...
    ...
    DZHAGA_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def dzhaga(self) -> global___ModuleConfig.DzhagaConfig:
        """
        TODO: REPLACE
        """
    ...
    def __init__(
        ...
        *,
        ...
        dzhaga: global___ModuleConfig.DzhagaConfig | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["ambient_lighting", b"ambient_lighting", "audio", b"audio", "canned_message", b"canned_message", "detection_sensor", b"detection_sensor", "dzhaga", b"dzhaga", "external_notification", b"external_notification", "mqtt", b"mqtt", "neighbor_info", b"neighbor_info", "paxcounter", b"paxcounter", "payload_variant", b"payload_variant", "range_test", b"range_test", "remote_hardware", b"remote_hardware", "serial", b"serial", "store_forward", b"store_forward", "telemetry", b"telemetry"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ambient_lighting", b"ambient_lighting", "audio", b"audio", "canned_message", b"canned_message", "detection_sensor", b"detection_sensor", "dzhaga", b"dzhaga", "external_notification", b"external_notification", "mqtt", b"mqtt", "neighbor_info", b"neighbor_info", "paxcounter", b"paxcounter", "payload_variant", b"payload_variant", "range_test", b"range_test", "remote_hardware", b"remote_hardware", "serial", b"serial", "store_forward", b"store_forward", "telemetry", b"telemetry"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["payload_variant", b"payload_variant"]) -> typing.Literal["mqtt", "serial", "external_notification", "store_forward", "range_test", "telemetry", "canned_message", "audio", "remote_hardware", "neighbor_info", "ambient_lighting", "detection_sensor", "paxcounter", "dzhaga"] | None: ...
